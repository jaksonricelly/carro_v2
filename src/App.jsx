    ...
    <main>
      <section>
        <div className="bg-orange">
          ...
          <h2>Sedans</h2>
          <p className="font-big-shoulders">Escolha um sedan pelo seu preço acessível e excelente economia de combustível. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
        ...
        <div className="bg-dark-green">
          <img src={iconLuxuosos} alt="Icone dos carros luxuosos" />
          <h2>Luxuosos</h2>
